...
$version['api_version']     = "3.0.10"; // API version of the registrar
$version['date']            = "2026-06-24"; // Last modification date
$version['version']         = "2.0.10"; // Version released for HostFact
