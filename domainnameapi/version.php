...
$version['api_version']     = "3.0.4"; // API version of the registrar
$version['date']            = "2026-05-07"; // Last modification date
$version['version']         = "2.0.4"; // Version released for HostFact
